...
public class SignUpActivity extends Activity {
	...
	protected void sharedPrefernces() {
		pref = getSharedPreferences("SignUp Credentials", MODE_PRIVATE);
		editor = pref.edit();
	...
	private void InitView() {
		...
		skip.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				 ...
				 */
				Intent i = new Intent(SignUpActivity.this, Choose_spinner_country.class);
				startActivity(i);
			...
			public void onClick(View v) {
				...
				if (cd.isConnectingToInternet()) {
					if (name.getText().toString().length() > 1
						...
						System.out.println("Singleton.pass == "+Singleton.pass);
						
						
						SignUpRequest(Singleton.name, Singleton.email, Singleton.pass, "1");
		...
		signUp_fb.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				LoginManager.getInstance().logInWithReadPermissions(
						SignUpActivity.this, Arrays.asList("email", "user_friends", "public_profile"));
													...
													public void onCompleted(JSONObject object,
														...
														try {
															...
															if (object.has("email")) {
																...
																SignUpRequest_Fb(Singleton.email,																	
																		Singleton.social_id,
																		Singleton.name, "2");
															}	
															else
					...
					public void onResponse(String response) {
						...
						try {
							...
							if (json.getString("code").equals("200")) {
								...
								//JSONObject obj1 = json.getJSONObject("user_id");
							...
							else { //if (json.getString("code").equals("201")) {						
	...
	private void SignUpRequest(final String name, final String email, final String pass, final String type) {
		//progress.setVisibility(View.VISIBLE);
						...
						TwitterUserShowRequest request = new TwitterUserShowRequest(
								...
								new TwitterRequestCallBack() {				
									...
									public void onSuccess(JSONObject jsonObject) {
										...
										/*
										 * signUpRequest_Twt(email.getText().
										 * toString(),
										 * name.getText().toString(),
										 * social_id.toString(), "3");
										 */
									}
									...
									public void onSuccess(String jsonResult) {
										...
										System.out
										  ...
										  signUpRequest_Twt(email.getText()
										  .toString(), Singleton.name, Singleton.social_id,
										  "3");
									...
									public void onFailure(Exception e) {
										// TODO Auto-generated method stub
										System.out.println("SignUp Success e +"
												+ e);
	 ...
	 * SignUpActivity.this, new TwtSocioCallBack() {
	 * 
	 * @Override public void onSuccess(TwtSocioUserDatas twtSocioUserDatas) { //
	 * CommonMethods.showMyToast(getActivity(), // "Login Success");
	 * 
	 * System.out.println("SignUp Success twtSocioUserDatas >>>>>>>>> +" +
	 * twtSocioUserDatas);
	 * 
	 * social_id = twtSocioUserDatas.getUserid();
	 * 
	 ...
	 * 
	 * @Override public void onSuccess(JSONObject jsonObject) { // TODO
	 ...
	 * 
	 * signUpRequest_Twt(email.getText().toString(), name.getText().toString() ,
	 * social_id.toString(),"3");
	 * 
	 * }
	 * 
	 * @Override public void onSuccess(String jsonResult) {
	 * 
	 * System.out.println("<<<<<<<<<<<<       ONSUCCESS 2     >>>>>>>>>>>>>");
	 * // TODO Auto-generated method stub
	 * 
	 * signUpRequest_Twt(email.getText().toString(), name.getText().toString() ,
	 * social_id.toString(),"3"); System.out
	 * .println("  TwitterUserShowRequest jsonObject +" + jsonResult);
	 * 
	 * }
	 * 
	 * @Override public void onFailure(Exception e) { // TODO Auto-generated
	 * method stub System.out.println("Login Success e +" + e);
	 * 
	 * } });
	 * 
	...
	public class SignUpWithTwitter extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... params) {
			...
			/*
			 * String url = ConstantUrl.Url_main + ConstantUrl.Url_signup; //
			 * key and value pair List<NameValuePair> nameValuePair = new
			 ...
			 * BasicNameValuePair("twitter_id", social_id));
