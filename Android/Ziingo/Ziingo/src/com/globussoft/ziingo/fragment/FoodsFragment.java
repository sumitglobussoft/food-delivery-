...
import com.globussoft.ziingo.Type_Location;
...
public class FoodsFragment extends Fragment {
	...
	private void InitUI() {
		...
		location.setText(Singleton.Spn_CityName + ", "
	...
	protected void sharedPrefernces() {
		...
		pref   = this.getActivity().getSharedPreferences("Selected_Hotel", PRIVATE_MODE);
		editor = pref.edit();
						...
						try {
							...
							if (json.getString("code").equals("200")) {
								...
								for (int j = 0; j < jsonMainArr.length(); j++) {
									...
									/*									 * 
									 * restListModel.setCuisine(childJSONObject.getString("Cuisine"));
									 */
