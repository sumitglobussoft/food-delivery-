...
public class AuthSignaturesGeneratorRequestToken {
	...
	public AuthSignaturesGeneratorRequestToken(String cKey, String cSecret,
			String method) {
	...
	String gentratedPerams() {
		...
		try {
			...
			GeneratedPerams = OAUTH_CALLBACK
					+ "="
					+ URLEncoder.encode(MainSingleTon.oauth_callbackURL,
							"ISO-8859-1") + "&" + OAUTH_CONSUMER_KEY + "="
