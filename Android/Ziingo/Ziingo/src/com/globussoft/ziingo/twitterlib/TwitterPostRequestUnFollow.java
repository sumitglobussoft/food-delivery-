...
public class TwitterPostRequestUnFollow {
	...
	public TwitterPostRequestUnFollow(TwtSocioUserDatas userDatas,
			TwitterRequestCallBack twitterRequestCallBack) {
	...
	public void myDoInBackground(String id) {
		...
		String url = MainSingleTon.unFollowUrl;
		...
		try {
			...
			myprint("uuuuuuuuuuurl " + url);

			myprint("pramsssssssssss" + peramPairs.toString());
