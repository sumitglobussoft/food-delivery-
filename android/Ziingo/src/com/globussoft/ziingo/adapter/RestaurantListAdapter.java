...
public class RestaurantListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		*/
		...
		for (Object str : Singleton.Rest_cuisines) 
		{
			string.append(str.toString());	
		}
		
		cuisines = string.toString();
		cuisines = cuisines.replaceAll(" cuisine", ", ");
		cuisines = cuisines.substring(0, cuisines.lastIndexOf(","));
		System.out.println("Singleton.Rest_cuisines (string )>>> "+cuisines);
		
		cuisine.setText("Cuisines: "+cuisines);*/
