...
public class ConstantUrl {
	...
	public static String Url_InsertUpdateAllOrdersToCart = "addto-cart?method=InsertUpdateAllOrdersToCart";
	...
	public static String Url_fetchdeliveryaddress = "user-delivery-settings?method=fetchdeliveryaddress";
	...
	public static String Url_getorderstatus = "orders?method=orderstatus";
	public static String Url_historyorders = "orders?method=historyorders";
	...
	public static String Url_fetchhotelbycuisine = "search-hotels-by?method=selectcuisines";
	
	public static String Url_forgot_password = "forgot-password";
	public static String Url_getuserprofileinfo = "user-profile?method=getuserprofileinfo";
	public static String Url_changepassword = "user-account-settings?method=changepassword";
