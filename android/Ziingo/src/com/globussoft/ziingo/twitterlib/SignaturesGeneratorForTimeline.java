...
public class SignaturesGeneratorForTimeline {
	...
	public SignaturesGeneratorForTimeline(TwtSocioUserDatas modelUserDatas, 
...
//					+"\", "  +  OAUTH_TOKEN           	    	+"=\""    + URLEncoder.encode(modelUserDatas.getUserAcessToken(),"ISO-8859-1") 
//			        +"\"" ;
	...
	String genrateSigningKey(){
		...
		try {
			...
			singningKey = URLEncoder.encode(cSecret,"ISO-8859-1")+"&"+modelUserDatas.getUsersecretKey();
