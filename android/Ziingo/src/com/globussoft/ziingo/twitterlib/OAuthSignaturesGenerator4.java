...
public class OAuthSignaturesGenerator4 {
	...
	public OAuthSignaturesGenerator4(String accesToken, String tokenSecret,
	...
	String gentratedPerams(List<BasicNameValuePair> peramPairs){
		...
		if(peramPairs.size()>0){
			...
			for( int i = 0 ;i<peramPairs.size();++i){
				...
				GeneratedPerams = GeneratedPerams  +"&" +peramPairs.get(i).getName()+"=" +  peramPairs.get(i).getValue() ;
