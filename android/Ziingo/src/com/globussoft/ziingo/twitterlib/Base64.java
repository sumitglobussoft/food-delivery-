...
public class Base64 {
	 ...
	 * described in Section 4 of RFC3548: It is important to note that data
	 * encoded this way is <em>not</em> officially valid Base64, or at the very
	 * least should not be called Base64 without also specifying that is was
	 ...
	 * RFC3548: Notice that the last two bytes become "hyphen" and "underscore"
